...
if(!preg_match('/^[-_\p{L}\d]+$/ui', $username)){
    $formErrors[] = "Only alphanumeric characters, hypens, and underscores are permitted in username.";
}
if($password != $retyped){
    $formErrors[] = "You passwords don't match.";
}
...
if(!$errors)
{
    ...
    else
    {
        ...
        // move internal pointer to the beginning of the file
        rewind($file);
