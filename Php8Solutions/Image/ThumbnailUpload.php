...
require_once __DIR__ . '/../File/MultiUpload.php';
require_once 'Thumbnail.php';

class ThumbnailUpload extends MultiUpload
{
    public function __construct(
        protected string $field,
        protected string $path,
        protected int $max = 512000,
    ...
    )
    {
        ...
        {
            // elimina las barras diagonales finales y concatena
            // el separador de directorio apropiado para cada SO.
            $this->thumbPath = rtrim($this->thumbPath, '/\\') . 
            DIRECTORY_SEPARATOR;
        }
        else
        {
            throw new \Exception("$this->thumbPath must be valid, writable directory.");
        }
        parent::__construct($this->field, $this->path, $this->max);
    }
